...
public partial class GameContext {
    ...
    public GameEntity shootEntity { get { return GetGroup(GameMatcher.Shoot).GetSingleEntity(); } }

    public bool isShoot {
        get { return shootEntity != null; }
        set {
            var entity = shootEntity;
            if (value != (entity != null)) {
                if (value) {
                    CreateEntity().isShoot = true;
                } else {
                    entity.Destroy();
                }
            }
