...
public class UpdatePointerLengthSystem : IExecuteSystem, IInitializeSystem
{
    ...
    public UpdatePointerLengthSystem(Contexts contexts)
    {
        ...
        screenCorners = new Vector2[]
        {
            mainCamera.ScreenToWorldPoint(new Vector2(0, 0)),
            mainCamera.ScreenToWorldPoint(new Vector2(0, mainCamera.pixelHeight)),
