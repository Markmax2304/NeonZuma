...
/// <summary>
/// Логика обновления скоростей цепей на треке
/// </summary>
public class SetChainSpeedSystem : ReactiveSystem<GameEntity>, IInitializeSystem, ICleanupSystem, ITearDownSystem
{
    ...
    {
        var chains = _contexts.game.GetEntities(GameMatcher.ChainId);
        foreach (var chain in chains)
        {
            chain.Destroy();
        }

        if (_contexts.global.hasCurrentNormalSpeed)
        {
            _contexts.global.RemoveCurrentNormalSpeed();
        }
    }
